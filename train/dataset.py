...
class Badminton_Dataset(Dataset):
    def __init__(self, root_dir='dataset', split='train', mode='2d', num_frame=3, slideing_step=1, frame_dir=None, debug=False):
        """
        Args:
    ...
    def __getitem__(self, idx):
        ...
        coors[:, 0] = coors[:, 0] / w_ratio
        coors[:, 1] = coors[:, 1] / h_ratio
